package com.stackroute.PE2;import org.junit.After;
import org.junit.Before;
import org.junit.Test;
import java.util.Scanner;
import java.io.*;
import static org.junit.Assert.*;public class UpperCaseTest {
    UpperCase uppercase;
@Before
public void setup() {
...
//    }
   @Test
    public void upperCaseSuccess2() throws IOException {//        File file = new File("./src/main/inputFiles/input2.txt");
//        String path = file.getAbsolutePath();
        //assertNull("The filename Dosen't exist",uppercase.upperCase(" "));
